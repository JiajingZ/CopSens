...
Below, we visualize the analysis results. The Spearman’s rank correlation between the estimated treatment effects of Miao et al. (2020) with the null treatment assumption ("miao$\_$nulltr") and ones by our MCC procedure with either the L1 ("multicali$\_$L1") or L2 minimization ("multicali$\_$L2") is 0.93. In the plot below, the blue, green and yellow bars are closely grouped together for majority of treatments.
